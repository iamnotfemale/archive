...
- 소개 문장, 경력·학력 같은 섹션, 연락처는 오른쪽 위 "수정"으로 그 자리에서 고칩니다. 손잡이(≡)를 끌어 순서를 바꾸고, "+ 항목" "+ 섹션" "+ 연락처"로 늘리고, ×로 지웁니다. 바뀐 내용은 자동 저장되며 "완료" 또는 Esc로 나옵니다
...
| 이력·연락처 수정 | `/portfolio`에서 오른쪽 위 "수정" → 고치고 끌어서 순서 바꾸기 → "완료" |
